...
namespace DigitalOcean
{
    public partial class DOClient
    {
        ...
        public virtual EventPointer RestartDroplet(int server_id)
        {
            var request = new RestRequest();
        ...
        public virtual EventPointer PowercycleDroplet(int server_id)
        {
            var request = new RestRequest();
        ...
        public virtual EventPointer ShutdownDroplet(int server_id)
        {
            var request = new RestRequest();
        ...
        public virtual EventPointer PoweroffDroplet(int server_id)
        {
            var request = new RestRequest();
        ...
        public virtual EventPointer PoweronDroplet(int server_id)
        {
            var request = new RestRequest();
        ...
        public virtual EventPointer ResetPasswordDroplet(int server_id)
        {
            var request = new RestRequest();
        ...
        public virtual EventPointer ResizeDroplet(int server_id, int size_id)
        {
            var request = new RestRequest();
        ...
        public virtual EventPointer SnapshotDroplet(int server_id, string snapshot_name = "")
        {
            var request = new RestRequest();
        ...
        public virtual EventPointer RestoreDroplet(int server_id, int image_id)
        {
            var request = new RestRequest();
        ...
        public virtual EventPointer RebuildeDroplet(int server_id, int image_id)
        {
            var request = new RestRequest();
        ...
        public virtual EventPointer RenameDroplet(int server_id, int name)
        {
            var request = new RestRequest();
        ...
        public virtual EventPointer DestroyDroplet(int server_id, bool scrub_data = false)
        {
            var request = new RestRequest();
